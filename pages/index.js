          ...
          <div>
            <pre>
              <code className="lang-jsx">
                ...
                <span className="hljs-string">"container-fluid"</span>&gt;{"\n"}
                {"      "}&lt;input{"\n"}
                {"        "}
                ...
                {"\n"}
                {"        "}className=
                <span className="hljs-string">"form-control d-none"</span>
                {"\n"}
                {"        "}accept=<span className="hljs-string">".pdf"</span>
                {"\n"}
                {"        "}
                ...
                <span className="hljs-keyword">let</span> i ={" "}
                <span className="hljs-number">0</span>; i &lt;
                e.target.files.length; i++) {"{"}
                {"\n"}
                {"            "}
                <span className="hljs-keyword">const</span> file =
                e.target.files[i];{"\n"}
                {"            "}
                ...
                {"          "}&lt;button{"\n"}
                {"            "}className=
                <span className="hljs-string">"btn btn-primary my-2"</span>
                {"\n"}
                {"            "}
                <span className="hljs-keyword">type</span>=
                ...
                {"          "}&lt;/button&gt;{"\n"}
                {"          "}&lt;<span className="hljs-keyword">div</span>{" "}
                className=<span className="hljs-string">"accordion"</span> id=
                <span className="hljs-string">"settings"</span>&gt;{"\n"}
                {"            "}&lt;<span className="hljs-keyword">div</span>{" "}
                className=<span className="hljs-string">"accordion-item"</span>
                &gt;{"\n"}
                {"              "}&lt;h2 className=
                <span className="hljs-string">"accordion-header"</span> id=
                ...
                {"\n"}
                {"                  "}data-bs-toggle=
                <span className="hljs-string">"collapse"</span>
                {"\n"}
                {"                  "}data-bs-target=
                ...
                {"                "}&lt;
                <span className="hljs-keyword">div</span> className=
                <span className="hljs-string">"accordion-body"</span>&gt;
                <span className="hljs-type">Page</span>{" "}
                <span className="hljs-type">Settings</span>{" "}
                <span className="hljs-type">Goes</span>{" "}
                <span className="hljs-type">Here</span>&lt;/
                <span className="hljs-keyword">div</span>&gt;{"\n"}
                {"              "}&lt;/<span className="hljs-keyword">div</span>
                &gt;{"\n"}
                {"            "}&lt;/<span className="hljs-keyword">div</span>
                ...
                {"\n"}
                {"          "}className=
                <span className="hljs-string">"col-sm-8 my-3"</span>
                {"\n"}
                {"          "}style={"{"}
                {"{"}
                {"\n"}
                ...
                {"        "}&gt;{"\n"}
                {"          "}&lt;<span className="hljs-keyword">div</span>{" "}
                className=<span className="hljs-string">"container"</span>&gt;
                {"\n"}
                {"            "}&lt;<span className="hljs-keyword">div</span>{" "}
            ...
            <pre>
              <code className="lang-jsx">
                ...
                <span className="moonscript">
                  <span className="hljs-keyword">import</span> {"{"} useRouter{" "}
                  {"}"} <span className="hljs-keyword">from</span>{" "}
                  ...
                  {"\n"}
                  <span className="hljs-keyword">import</span> styles{" "}
                  <span className="hljs-keyword">from</span>{" "}
                  <span className="hljs-string">
                  ...
                  ;{"\n"}
                  <span className="hljs-keyword">import</span> FilePreview2{" "}
                  <span className="hljs-keyword">from</span>{" "}
                  <span className="hljs-string">
                  ...
                  {"\n"}
                  {"      "}className=
                  <span className="hljs-string">"bi bi-grip-horizontal"</span>
                  {"\n"}
                  {"      "}viewBox=
                  ...
                  {"      "}&lt;path d=
                  <span className="hljs-string">
                    "M2 8a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0-3a1 1 0 1 1 0 2 1 1 0 0
                    1 0-2zm3 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0-3a1 1 0 1 1 0 2 1
                    1 0 0 1 0-2zm3 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0-3a1 1 0 1 1
                    0 2 1 1 0 0 1 0-2zm3 3a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0-3a1 1
                    0 1 1 0 2 1 1 0 0 1 0-2zm3 3a1 1 0 1 1 0 2 1 1 0 0 1
                    0-2zm0-3a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"
                  </span>{" "}
                  /&gt;{"\n"}
                  {"    "}&lt;/svg&gt;{"\n"}
                  {"  "}&lt;/span&gt;{"\n"}));{"\n"}
                  ...
                  className={"{"}styles.dragContainer{"}"}&gt;{"{"}children{"}"}
                  &lt;/div&gt;;{"\n"}
                  {"}"});{"\n"}
                  {"\n"}const arrayMoveMutate ={" "}
                  <span className="hljs-function">
                    <span className="hljs-params">
                      (array, <span className="hljs-keyword">from</span>, to)
                    </span>{" "}
                    =&gt;
                  </span>{" "}
                  {"{"}
                  ...
                  to, <span className="hljs-number">0</span>, array.splice(
                  <span className="hljs-keyword">from</span>,{" "}
                  ...
                  <span className="hljs-keyword">from</span>, to);{"\n"}
                  {"  "}
                  <span className="hljs-keyword">return</span> array;{"\n"}
                  {"}"};{"\n"}
                  {"\n"}
                  <span className="hljs-keyword">export</span> default function
                  PDFList({"{"} files, setFiles {"}"}) {"{"}
                  {"\n"}
                  {"  "}const router = useRouter();{"\n"}
                  ...
                  {"\n"}
                  {"    "}
                  <span className="hljs-keyword">return</span> path ==={" "}
                  <span className="hljs-string">"split"</span> ? ({"\n"}
                  {"      "}&lt;div className={"{"}styles.dragElement2{"}"}&gt;
                  {"\n"}
                  {"        "}&lt;DragHandle /&gt;{"\n"}
                  {"        "}&lt;FilePreview2 file={"{"}value{"}"}{" "}
            ...
            <p>
              ...
              PDFButtons from "./PDFButtons"; import imageDataURLfromFile from
              "../../methods/imageDataURLfromFile";
            </p>
            <p>
            ...
            <p>
              {" "}
              useEffect(() =&gt; {"{"}
              const temp = []; const arr = Array.from(files); const myFunction =
              async () =&gt; {"{"}
              const addFileButton = document.getElementById("addFileButton");
              const processFileButton =
              document.querySelectorAll("#processFileButton");
              addFileButton.innerText = "Adding Files ...";
              addFileButton.disabled = true; processFileButton.forEach((btn)
              =&gt; (btn.disabled = true));
            </p>
            <pre>
              <code>
                {"  "}for (let i = <span className="hljs-number">0</span>
                ...
                <span className="hljs-comment">;</span>
                {"\n"}
                {"    "}file.image = res<span className="hljs-meta">.data</span>
                <span className="hljs-comment">;</span>
                {"\n"}
                {"    "}file.pages = res.pageCount
                <span className="hljs-comment">;</span>
                ...
                <span className="hljs-keyword">
                  addFileButton.innerText{" "}
                </span>= <span className="hljs-string">"Add Files"</span>
                <span className="hljs-comment">;</span>
                {"\n"}
                {"  "}
                <span className="hljs-keyword">addFileButton.disabled </span>=
                false<span className="hljs-comment">;</span>
                {"\n"}
                {"  "}processFileButton.forEach((
                <span className="hljs-keyword">btn) </span>=&gt; (
            ...
            <p>
              ...
              e.target.innerText = "Processing Files...."; e.target.disabled =
              true; const filteredFiles = filesLocal.filter((file) =&gt;
              !file.deleted); await method(filteredFiles); e.target.innerText =
              "Save and Download"; e.target.disabled = false;
              {"}"};
            </p>
            <p> return (</p>
