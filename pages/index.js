...
import Editor from "components/prism/Basic";
import {Wrapper} from "components/prism/styles";
import React from "react";
import {Pre} from "./styles";
import Highlight, {defaultProps} from "prism-react-renderer";
import theme from "prism-react-renderer/themes/nightOwl";

const exampleCode = `var NewComponent = React.createClass({
  render: function() {
    return (
      <div>
...
export default function home() {
    return ( <
            ...
            Head >
            <
            title > pdftoolz - Home < /title > < a href = "https://github.com/bgoonz/pdf-tools" > Github Repo < /a> < /Head > < div > < br > < /br>
            ...
            center >
            <
            img src = "https://i.imgur.com/5 JDpzgO.gif " / >
 < /center> <
            h5 > Code Samples: < /h5 > < Basic > < /Basic> <
            Wrapper >
            <
            div >
            <
            ...
            import < /span > {
            " "
        } < span className = "hljs-type" > React < /span>, {"{"} useRef {"}"}{" "} <
            ...
            import < /span > {
            " "
        } < span className = "hljs-type" > PDFList < /span>{" "} <
            span className = "hljs-keyword" > from < /span > {
            " "
        } < span className = "hljs-string" > "./PDFList" < /span>;{"\n"} <
            span className = "hljs-keyword" >
            import < /span > {
            " "
        }
        imageDataURLfromFile < span className = "hljs-keyword" > from < /span>{" "} <
            span className = "hljs-string" >
            "../../methods/imageDataURLfromFile " <
 / span >;
        {
            "\n"
        } {"\n"} < span className = "hljs-keyword" > export < /span> default function{" "} <
    span className = "hljs-type" > PDFButtons < /span > ({"{"} {
            "\n"
        } {
            "  "
        }
...
span className = "hljs-keyword" > ref < /span > = useRef();
        {
            "\n"
        } {"  "} < span className = "hljs-keyword" > return </span>({"\n"} {
            "    "
...
span className = "hljs-string" > "container-fluid" < /span >& gt;
        {
            "\n"
        } {"      "} & lt;
        input {
...
span className = "hljs-string" > "file" < /span > {
            "\n"
        } {
            "        "
        }
...
span className = "hljs-keyword" > ref < /span > {
        ...
        async (e) = &gt;
        {
            ...
            "          "
        } < span className = "hljs-keyword" > const < /span> addFileButton =
document.getElementById( <
        span className = "hljs-string" > "addFileButton" < /span >);
        {
            "\n"
        } {"          "} < span className = "hljs-keyword" > const < /span> processFileButton = {
"\n"
...
document.querySelectorAll( <
    span className = "hljs-string" > "#processFileButton" < /span >);
        {
            "\n"
        } {"\n"} {
            "          "
        ...
        addFileButton.innerText = {
            " "
        } < span className = "hljs-string" > "Adding Files ..." < /span>;{"\n"} {
"          "
}
addFileButton.disabled = {
    ...
    span className = "hljs-literal" > true < /span >;
        ...
        processFileButton.forEach((btn) = &gt;
        (btn.disabled = <span className = "hljs-literal" > true < /span>)); {
            "\n"
        } {
            "\n"
        } {
...
span className = "hljs-keyword" >
    const < /span > file = e.target.files[i];
    {
        "\n"
    } {"            "} < span className = "hljs-keyword" > const < /span> res = await
...
span className = "hljs-keyword" > ref < /span >.current.value = {
        " "
...
addFileButton.innerText = {
    ...
    span className = "hljs-string" > "Add Files" < /span >;
    {
        "\n"
    } {"          "}
    addFileButton.disabled = {
...
processFileButton.forEach((btn) = & gt;
    (btn.disabled = < span className = "hljs-literal" > false < /span >)
);
{
    "\n"
} {"        "} {
...
className = <
    span className = "hljs-string" > "btn btn-danger my-2 mx-1" < /span > {
    "\n"
} {
    "            "
}
...
{
    "\n"
} {"            "} < span className = "hljs-type" > Save < /span>{" "} <
span className = "hljs-keyword" > and < /span > {
    " "
} < span className = "hljs-type" > Download < /span> {
"\n"
} {
    "          "
} & lt;
...
{
    " "
} < span className = "hljs-keyword" > ref < /span>.current.click(){"}"} {
"\n"
} {
    "          "
} & gt; {
...
span className = "hljs-type" > Add < /span > {
    " "
} < span className = "hljs-type" > Files < /span> {
"\n"
} {
    "          "
} & lt;
...
<span className = "hljs-keyword" > div < /span>{" "}
className = < span className = "hljs-string" > "accordion" < /span > id = <span className = "hljs-string" > "settings" < /span>&gt;{"\n"} {
"            "
} & lt; < span className = "hljs-keyword" > div < /span > {
    " "
}
className = <span className = "hljs-string" > "accordion-item" < /span> &
gt; {
    "\n"
} {
    "              "
...
h2 className = <
    span className = "hljs-string" > "accordion-header" < /span > id = <span className = "hljs-string" > "pageSettings" < /span>&gt;{"\n"} {
"                "
} & lt;
button {
    "\n"
...
data - bs - target = <
    span className = "hljs-string" > "#pageSetting" < /span > {
    "\n"
} {
    "                  "
}
...
{
    "\n"
} {"                  "} < span className = "hljs-type" > Page < /span>{" "} <
span className = "hljs-type" > Settings < /span > {
    "\n"
} {
    "                "
} & lt;
...
aria - labelledby = <
    span className = "hljs-string" > "pageSettings" < /span > {
    "\n"
} {
    "                "
}
...
span className = "hljs-keyword" > div < /span > className = <span className = "hljs-string" > "accordion-body" < /span>&gt; <
span className = "hljs-type" > Page < /span > {
    " "
} < span className = "hljs-type" > Settings < /span>{" "} <
span className = "hljs-type" > Goes < /span > {
    " "
} < span className = "hljs-type" > Here < /span>&lt;/ < span className = "hljs-keyword" > div < /span>&gt;{"\n"} {
"              "
} & lt;
/ < span className = "hljs-keyword" > div < /span >
&
...
h2 className = <
    span className = "hljs-string" > "accordion-header" < /span > id = <span className = "hljs-string" > "marginSettings" < /span>&gt;{"\n"} {
"                "
} & lt;
button {
    "\n"
...
className = <
    span className = "hljs-string" > "accordion-button" < /span > {
    "\n"
} {
    "                  "
} < span className = "hljs-keyword" > type < /span>= <
...
data - bs - target = <
    span className = "hljs-string" > "#marginSetting" < /span > {
    "\n"
} {
    "                  "
}
...
{
    "\n"
} {"                  "} < span className = "hljs-type" > Margin < /span>{" "} <
span className = "hljs-type" > Settings < /span > {
    "\n"
} {
    "                "
...
aria - labelledby = <
    span className = "hljs-string" > "marginSettings" < /span > {
    "\n"
} {
    "                "
}
...
/ < span className = "hljs-keyword" > div < /span > & gt; {
    "\n"
} {
    "        "
} & lt;
...
height: {
    ...
    span className = "hljs-string" > "50vh" < /span >, {"\n"} {
    "            "
}
overflowY : {
    " "
} < span className = "hljs-string" > "scroll" < /span>,{"\n"} {
"            "
}
border: {
        " "
    } <
    span className = "hljs-string" > "2px dashed red" < /span >, {"\n"} {
    "          "
} {
    "}"
} {
...
<span className = "hljs-keyword" > div < /span>{" "}
className = < span className = "hljs-string" > "container" < /span >& gt;
{
    "\n"
} {"            "} & lt;
<span className = "hljs-keyword" > div < /span>{" "}
className = < span className = "hljs-string" > "row gy-3" < /span > style =
    {
    "{"
} {
    "{"
}
padding : < span className = "hljs-string" > "2rem 0px" < /span>{" "} {
"}"
} {
    "}"
} & gt; {
    ...
    "              "
} & lt; < span className = "hljs-type" > PDFList < /span > {
    " "
}
files =
    {
...
span className = "hljs-string" > "next/router " < /span>;{" \n "} <
 span className = "hljs-keyword" > import < /span> {"{"} {
"\n"
} {
    "  "
...
sortableHandle, {
    ...
    " "
} < span className = "hljs-string" > "react-sortable-hoc" < /span>; {
"\n"
} <
span className = "hljs-keyword" >
    import < /span > styles {
...
span className = "hljs-string" >
    "../../styles/filelist.module.css " <
 / span >;
{
    "\n"
} < span className = "hljs-keyword" > import < /span> FilePreview{" "} <
span className = "hljs-keyword" > from < /span > {
    " "
} < span className = "hljs-string" > "../FilePreview/FilePreview" < /span>; {
"\n"
} <
span className = "hljs-keyword" >
    import < /span > FilePreview2 {
    " "
} < span className = "hljs-keyword" > from < /span>{" "} <
span className = "hljs-string" >
...
< span className = "hljs-function" > < span className = "hljs-params" > ({"{"}
tabIndex {
    "}"
}) < /span>{" "} = & gt; < /
span > {
...
viewBox = <
    span className = "hljs-string" > "0 0 16 16" < /span > {
    "\n"
} {
    "    "
} & gt;
...
path d = <span className = "hljs-string" > "M2 8a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm0-3a1 1 0 1 1 0 2 1 1 0 0
 1 0 - 2 zm3 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm0 - 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm3 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm0 - 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm3 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm0 - 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm3 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 zm0 - 3 a1 1 0 1 1 0 2 1 1 0 0 1 0 - 2 z " < /
 span > {
    " "
} / & gt;
{
...
sortableContainer(< span className = "hljs-function" > < span className = "hljs-params" > ({"{"}
children {
    "}"
}) < /span>{" "} = & gt; < /span > {
    " "
    ...
    "  "
} < span className = "hljs-keyword" > return </span>& lt;
div
className = {
    "{"
}
...
const arrayMoveMutate = {
    ...
    (array, < span className = "hljs-keyword" > from < /span >,
to) < /
        span > {
            " "
        } = & gt; <
...
{
    " "
} < span className = "hljs-number" > 0 < /span> ? array.length + to :
    to, < span className = "hljs-number" > 0 < /span >, array.splice(< span className = "hljs-keyword" > from < /span>,{" "} <
...
const path = router.pathname.split( <
    span className = "hljs-string" > "/" < /span>).reverse()[ <
...
const deleteFileHandler = {
    ...
    span className = "hljs-function" >
    <
    span className = "hljs-params" > (file) < /span > = &gt;
    </
    span > {
        " "
    } {
...
newFiles.forEach( <
    span className = "hljs-function" >
    <
    span className = "hljs-params" > (fileNew) < /span > = &gt;
    </
    span > {
        " "
    } {
...
const SortableItem = sortableElement( <
    ...
    return </span > path === {
        " "
    } < span className = "hljs-string" > "split" < /span> ? ({"\n"} {
    "      "
} & lt;
div className = {
    "{"
...
let allDeleted = {
    ...
    useDragHandle axis = <span className = "hljs-string" > "xy" < /span> &
gt; {
    "\n"
} {
    "      "
...
files.map( <
    span className = "hljs-function" >
    <
    span className = "hljs-params" > (file, index) < /span > = &gt;
    </
    span > {
        " "
    } {
...
/p > < p > {
    ...
    for (let i = < span className = "hljs-number" > 0 < /span > < span className = "hljs-comment" >;
    i & lt;
    arr.length;
    i ++) {
        "{"
...
const file = arr[i] <
    ...
    const res = await imageDataURLfromFile(file) < span className = "hljs-comment" >;
    </span> {
"\n"
} {
    "    "
}
file.image = res < span className = "hljs-meta" > .data < /span > < span className = "hljs-comment" >;
    </span> {
"\n"
} {
    "    "
...
file.pages = res.pageCount <
    ...
    temp.push(file) < span className = "hljs-comment" >;
    </span> {
"\n"
} {
    "  "
...
setFilesLocal(temp) < span className = "hljs-comment" > ; < /span > {
        ...
        "  "
    } < span className = "hljs-keyword" > addFileButton.innerText {
        " "
    } < /span>= <span className="hljs-string">"Add Files"</span > < span className = "hljs-comment" >;
    </span> {
"\n"
} {
    "  "
} <
span className = "hljs-keyword" > addFileButton.disabled < /span >= false < span className = "hljs-comment" >;
    </span> {
"\n"
} {
    "  "
...
processFileButton.forEach(( <
            span className = "hljs-keyword" > btn) < /span >=& gt;
    (< span className = "hljs-keyword" > btn.disabled < /span>= false)) <
        span className = "hljs-comment" > ; < /span > {
        "\n"
    } {
        "}"
...
const downloadPDFHandler = async (e) = & gt; {
    "{"
}
e.target.innerText = "Processing Files....";
e.target.disabled =
    true;
const filteredFiles = filesLocal.filter((file) = & gt; !file.deleted);
await method(filteredFiles);
e.target.innerText =
    "Save and Download";
e.target.disabled = false; {
...
/p > < p > return(< /p> <
        ...
        <
        pdfbuttons fileslocal = "{filesLocal}"
...
p / > < /div> < /Wrapper > < div > < div className = "container" style = {
        {
    ...
    } > < div className = "starter-template" style = {
        {
            boxSizing: "border-box",
            padding: "0px 15px"
        }
...
style = {
    ...
    PDF <
    /span >.js with < span className = "widont" style = {
        {
            boxSizing: "border-box"
        }
    } > & nbsp;
...
style = {
    ...
    PDF <
    /span >. ** please take a moment to understand the different layers ** the & nbsp;
...
tbody style = {
    ...
    } > The core layer is where a binary & nbsp;
    <span className = "caps" style = {
        {
            boxSizing: "border-box"
        }
...
for all subsequent layers. ** is not ** ** ** ** ** here because using it ** ** ** ** is considered an advanced usage and the & nbsp; <
span className = "caps"
style = {
        {
            boxSizing: "border-box"
    ...
    is likely to change.For an example of using the core layer see the & nbsp;
    <a href = "https://github.com/brendandahl/pdf.js.utils/tree/master/browser" style = {
        {
            boxSizing: "border-box",
            background: "0px 0px",
...
td style = {
    ...
    The display layer ** ** * the core ** ** * and exposes an easier to use & nbsp; <
span className = "caps"
style = {
        {
            boxSizing: "border-box"
    ...
    to render PDFs and get other ** ** ** ** ** * out of a document.This & nbsp;
    <span className = "caps" style = {
        {
            boxSizing: "border-box"
        }
...
is what the version number is based on. <
    ...
    } > The viewer is built on the display layer and is the & nbsp;
    <span className = "caps" style = {
        {
            boxSizing: "border-box"
        }
...
style = {
    ...
    * * ** ** ** ** ** ** * and the other browser extensions within the project.It can be a good starting point for ** ** ** ** your ** * viewer. & nbsp; < em style = {
    {
        boxSizing: "border-box"
    }
} > However, we do  ** * if you plan to embed the viewer in your own site, that it not just be an unmodified version.Please re - skin it or build ** ** it. < /em> < /td > < /tr> < /tbody > < /table> <
h2 style = {
        {
            boxSizing: "border-box",
            fontFamily: "inherit",
...
p style = {
    ...
    Includes the generic build of & nbsp; <
span className = "caps"
style = {
        {
            boxSizing: "border-box"
    ...
    PDF <
    /span >.js and the < span className = "widont"style = {
{
    boxSizing: "border-box"
}} > & nbsp;</span>
viewer. <
    /p > < span className = "btn-group-vertical centered"style = {
{
    boxSizing: "border-box",
    position: "relative",
    display: "inline-block",
    verticalAlign: "middle"
}} > < a className = "btn btn-primary"href = "https://github.com/mozilla/pdf.js/releases/download/v2.10.377/pdfjs-2.10.377-dist.zip"style = {
{
    boxSizing: "border-box",
    ...
    width: "140.625px",
    maxWidth: "100%"
}}type = "button" > Stable(v2 .10 .377) < /a> <
 ...
 style = {
{
    ...
    marginTop: "-1px",
    marginLeft: "0px"
}}type = "button" > Beta(v2 .11 .338) < /a> < /span > < /div> <
...
style = {
    ...
    PDF <
    /span >.js ** * the < span className = "widont"style = {
{
    boxSizing: "border-box"
}} > & nbsp;</span>
viewer. <
    /p > < span className = "btn-group-vertical centered"style = {
{
    ...
    display: "inline-block",
    verticalAlign: "middle"
}} > < a className = "btn btn-primary"href = "https://github.com/mozilla/pdf.js/releases/download/v2.10.377/pdfjs-2.10.377-legacy-dist.zip"style = {
{
    boxSizing: "border-box",
    background: "none 0px 0px rgb(66, 139, 202)",
    color: "rgb(255, 255, 255)",
...
style = {
    ...
    Source <
    /h3 > To get a local copy ** ** * ** ** ** * code,clone ** using git : < pre style = {
{
    boxSizing: "border-box",
    overflow: "auto",
...
"\n"} < /code> < /pre > < div className = "open_grepper_editor"style = {
{
    boxSizing: "border-box",
...
}}title = "Edit & Save To Grepper" / > < /div> < /div > < h2 style = {
{
    boxSizing: "border-box",
    fontFamily: "inherit",
    fontWeight: 500,
    ...
    marginBottom: "10px",
    fontSize: "30px"
}} > Including via a < span className = "widont"style = {
{
    boxSizing: "border-box"
}} > & nbsp;</span> <
span className = "caps"
...
style = {
    ...
    PDF <
    /span >.js is hosted on several free < span className = "widont"style = {
{
    boxSizing: "border-box"
}} > & nbsp;</span>
CDNs:
...
{
    boxSizing: "border-box"
}} > < a href = "https://www.jsdelivr.com/package/npm/pdfjs-dist"style = {
{
    boxSizing: "border-box",
    background: "0px 0px",
    color: "rgb(66, 139, 202)",
    textDecoration: "none"
}} > https : // www.jsdelivr.com/package/npm/pdfjs-dist< /a> < /li > < li style = {
{
    boxSizing: "border-box"
}} > < a href = "https://cdnjs.com/libraries/pdf.js"style = {
{
    boxSizing: "border-box",
    background: "0px 0px",
    color: "rgb(66, 139, 202)",
    textDecoration: "none"
}} > https : // cdnjs.com/libraries/pdf.js< /a> < /li > < li style = {
{
    boxSizing: "border-box"
}} > < a href = "https://unpkg.com/pdfjs-dist/"style = {
{
    boxSizing: "border-box",
    background: "0px 0px",
    color: "rgb(66, 139, 202)",
    textDecoration: "none"
}} > https : // unpkg.com/pdfjs-dist/< /a> < /li > < /ul> <
h2 style = {
        {
            boxSizing: "border-box",
            fontFamily: "inherit",
    ...
    /h2 > < p style = {
{
    boxSizing: "border-box",
    margin: "0px 0px 10px"
}} > Note that we only mention the most relevant ** ** * and < span className = "widont"style = {
{
    boxSizing: "border-box"
}} > & nbsp;</span>
folders. <
...
"                         "} - display layer 's source map{"\n"}│{"   "}├── pdf.worker.js {
 ...
 map {"\n"}├──web / {"\n"}│ {"   "}├──cmaps / {"                             "} - character maps(required by core) {"\n"}│ {"   "}├──compressed.tracemonkey - pldi - 09. pdf - PDF filefor testing purposes {"\n"}│ {"   "}├──debugger.js {"                        "} - helpful debugging features {"\n"}│ {"   "}├──images / {"                            "} - imagesfor the viewer and annotation icons {"\n"}│ {"   "}├──locale / {"                            "} - ** ** ** ** ** * files {"\n"}│ {"   "}├──viewer.css {"                         "} - viewer style sheet {"\n"}│ {"   "}├──viewer.html {"                        "} - viewer layout {"\n"}│ {"   "}├──viewer.js {"                          "} - viewer layer {"\n"}│ {"   "}└──viewer.js. ** * {"                      "} - viewer layer 's source map{"\n"}└── LICENSE < /
 code > < /pre> <
div className = "open_grepper_editor"
style = {
    {
        boxSizing: "border-box",
        display: "block !important",
        ...
        backgroundColor: "rgb(0, 0, 0) !important",
        backgroundImage: 'url("data:image/png ',
}}title = "Edit & Save To Grepper" / > < h3 style = {{boxSizing: "border-box",fontFamily: "inherit",fontWeight: 500,lineHeight: "1.1",color: "inherit",marginTop: "20px",marginBottom: "10px",fontSize: "24px"}} > Source < /h3> <
pre style = {
        {
            boxSizing: "border-box",
            overflow: "auto",
    ...
    } > ├──docs /{"                                  "} - website source code {"\n"}├──examples / {"                              "} - simple ** ** * examples {"\n"}├──extensions / {"                            "} - browser extension source code {"\n"}├──external / {"                              "} - third party code {"\n"}├──l10n / {"                                  "} - translation files {"\n"}├──src / {"\n"}│ {"   "}├──core / {"                              "} - core layer {"\n"}│ {"   "}├──display / {"                           "} - display layer {"\n"}│ {"   "}├──shared / {"                            "} - shared code between the core and display layers {"\n"}│ {"   "}├──interfaces.js {"                      "} - interface definitionsfor  ** * core / display layers {"\n"}│ {"   "}├──pdf. *.js {"                           "} - wrapper files ** * bundling {"\n"}│ {"   "}└──worker_loader.js {"                   "} - ** ** for developer builds to ** ** worker files {"\n"}├──test / {"                                  "} - unit,font and reference tests {"\n"}├──web / {"                                   "} - viewer layer {"\n"}├──LICENSE {"\n"}├──README.md {"\n"}├──gulpfile.js {"                            "} - build scripts / logic {"\n"}├──package - lock. ** ** {"                      "} - pinned dependency versions {"\n"}└──package.json {"                           "} - package definition and dependencies < /code> < /pre > < div className = "open_grepper_editor"style = {{boxSizing: "border-box",display: "block !important",height: "20px !important",width: "20px !important",position: "absolute !important",top: "0px !important",right: "0px !important",backgroundSize: "20px 20px !important",cursor: "pointer !important",backgroundColor: "rgb(0, 0, 0) !important",backgroundImage: 'url("data:image/png'}}title = "Edit & Save To Grepper" / > < h2 style = {{boxSizing: "border-box",fontFamily: "inherit",fontWeight: 500,lineHeight: "1.1",color: "inherit",marginTop: "20px",marginBottom: "10px",fontSize: "30px"}} > Trying the Viewer < /h2> <
p style = {
        {
            boxSizing: "border-box",
            margin: "0px 0px 10px"
    ...
    With the prebuilt ** source version, open & nbsp; <
code style = {
        {
            boxSizing: "border-box",
            fontFamily: '"Anonymous Pro", monospace',
    ...
    web /viewer.html < /code>{" "} in a browser and the test pdf should load.Note: the worker is not enabled
for file: // urls, so use a server. If you’re using
    the source build and have node, you can run & nbsp; <
code style = {
        {
            boxSizing: "border-box",
            fontFamily: '"Anonymous Pro", monospace',
...
h2 style = {
    ...
    More Information <
    /h2 > < p style = {{boxSizing: "border-box",margin: "0px 0px 10px"}} > For a further walkthrough ** a ** ** ** * viewer, ** * the ** ** * world example.More documentation ** * be found in our & nbsp;<a href = "https://github.com/mozilla/pdf.js/wiki"style = {{boxSizing: "border-box",background: "0px 0px",color: "rgb(66, 139, 202)",textDecoration: "none"}} > wiki < /a> <
span className = "widont"
style = {
        {
            boxSizing: "border-box"
    ...
    &
    nbsp; <
/span > too. < /p> < /section > < /div> < /div > < div className = "container"style = {{boxSizing: "border-box",marginRight: "auto",marginLeft: "auto",paddingLeft: "15px",paddingRight: "15px",width: "1170px",color: "rgb(51, 51, 51)",fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif',fontSize: "14px",fontStyle: "normal",fontVariantLigatures: "normal",fontVariantCaps: "normal",fontWeight: 400,letterSpacing: "normal",orphans: 2,textAlign: "start",textIndent: "0px",textTransform: "none",whiteSpace: "normal",widows: 2,wordSpacing: "0px",WebkitTextStrokeWidth: "0px",textDecorationThickness: "initial",textDecorationStyle: "initial",textDecorationColor: "initial"}} > < footer style = {{boxSizing: "border-box",display: "block",paddingTop: "40px",paddingBottom: "40px",marginTop: "100px",color: "rgb(119, 119, 119)",textAlign: "center",borderTop: "1px solid rgb(229, 229, 229)"}} > < p style = {{boxSizing: "border-box",margin: "0px 0px 10px"}} > ©Mozilla and individual contributors < /p> < /footer > < /div> < /div > < /div> < / >);}
