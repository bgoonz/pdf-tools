...
exports.modules = {
  /***/ 7313: /***/ (
    ...
    /* harmony import */ const _styles_fileupload_module_css__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(7623);
    /* harmony import */ const _styles_fileupload_module_css__WEBPACK_IMPORTED_MODULE_2___default =
      /*#__PURE__*/ __webpack_require__.n(
        _styles_fileupload_module_css__WEBPACK_IMPORTED_MODULE_2__
      );
    /* harmony import */ const react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(5282);
    /* harmony import */ const react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(
        react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__
      );

    function FileUploader({ setFiles, multiple }) {
      ...
      return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx(
        "div",
        {
          ...
          react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", {
            ref: wrapperRef,
            className:
              _styles_fileupload_module_css__WEBPACK_IMPORTED_MODULE_2___default()
                .dropFileInput,
            ...
            children: [
              ...
              react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", {
                className:
                  _styles_fileupload_module_css__WEBPACK_IMPORTED_MODULE_2___default()
                    .dropFileInput__label,
                children: [
                  /*#__PURE__*/ (0,
                  react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("svg", {
  ...
  /***/ 2238: /***/ (
    ...
    const router_ = __webpack_require__(6731);
    // EXTERNAL MODULE: external "react-sortable-hoc"
    const external_react_sortable_hoc_ = __webpack_require__(7597);
    // EXTERNAL MODULE: ./styles/filelist.module.css
    const filelist_module = __webpack_require__(3922);
    const filelist_module_default =
      /*#__PURE__*/ __webpack_require__.n(filelist_module);
    // EXTERNAL MODULE: external "react/jsx-runtime"
    const jsx_runtime_ = __webpack_require__(5282); // CONCATENATED MODULE: ./components/FilePreview/FilePreview.jsx
    function FilePreview({ file, deleteFileHandler }) {
    ...
    function FilePreview2_FilePreview({ file, deleteFileHandler }) {
      const ref = (0, external_react_.useRef)();
      let deg = file.degrees || 0;
      (0, external_react_.useEffect)(() => {
        file.degrees = deg;
    ...
    const SortableContainer = (0,
    external_react_sortable_hoc_.sortableContainer)(({ children }) => {
        ...
        ({ value }) => {
          return path === "split"
            ? /*#__PURE__*/ (0, jsx_runtime_.jsxs)("div", {
                ...
                children: [
                  /*#__PURE__*/ jsx_runtime_.jsx(DragHandle, {}),
                  /*#__PURE__*/ jsx_runtime_.jsx(FilePreview2_FilePreview, {
                    file: value,
            ...
            : /*#__PURE__*/ (0, jsx_runtime_.jsxs)("div", {
                ...
                children: [
                  /*#__PURE__*/ jsx_runtime_.jsx(DragHandle, {}),
                  /*#__PURE__*/ jsx_runtime_.jsx(FilePreview, {
                    file: value,
                    deleteFileHandler: deleteFileHandler,
                  }),
                ],
    ...
    const external_pdfjs_dist_ = __webpack_require__(4063); // CONCATENATED MODULE: ./methods/imageDataURLfromFile.js
    external_pdfjs_dist_.GlobalWorkerOptions.workerSrc =
    ...
    /* harmony default export */ const imageDataURLfromFile =
      imageDataURLFromFile; // CONCATENATED MODULE: ./components/PDF/PDFButtons.jsx
    function PDFButtons({
      filesLocal,
      setFilesLocal,
      downloadPDFHandler,
    ...
    function PDFTool({ files, method, multiple }) {
      const { 0: filesLocal, 1: setFilesLocal } = (0, external_react_.useState)(
        []
      );
      (0, external_react_.useEffect)(() => {
        const temp = [];
