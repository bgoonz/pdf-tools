...
exports.ids = [664];
exports.modules = {
  /***/ 2167: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    "use strict";
    ...
    const _react = _interopRequireDefault(__webpack_require__(9297));

    const _router = __webpack_require__(1063);

    const _router1 = __webpack_require__(4651);

    const _useIntersection = __webpack_require__(7426);
  ...
  /***/ 5965: /***/ (__unused_webpack_module, exports) => {
    "use strict";
  ...
  /***/ 1392: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const _getAssetPathFromRoute = _interopRequireDefault(
      __webpack_require__(2248)
    );

    const _requestIdleCallback = __webpack_require__(3447);
  ...
  /***/ 4651: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    "use strict";
    ...
    const _routerContext = __webpack_require__(8773);
  ...
  /***/ 7426: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    "use strict";
    ...
    const _react = __webpack_require__(9297);
  ...
  /***/ 7413: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    "use strict";
    ...
    const _router = __webpack_require__(4651);
  ...
  /***/ 1063: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const _normalizeTrailingSlash = __webpack_require__(5965);

    const _routeLoader = __webpack_require__(1392);

    const _denormalizePagePath = __webpack_require__(9325);

    const _normalizeLocalePath = __webpack_require__(5378);

    const _mitt = _interopRequireDefault(__webpack_require__(7162));

    const _utils = __webpack_require__(7620);

    const _isDynamic = __webpack_require__(9372);

    const _parseRelativeUrl = __webpack_require__(665);

    const _querystring = __webpack_require__(2747);

    const _resolveRewrites = _interopRequireDefault(__webpack_require__(2431));

    const _routeMatcher = __webpack_require__(333);

    const _routeRegex = __webpack_require__(3456);
